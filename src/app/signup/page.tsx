...
export const metadata: Metadata = {
  title: "Create Account | Save Properties & Get Market Updates",
  description:
    "Create a free account to save your favorite properties, get notified of price changes, and receive the latest Las Vegas real estate market insights.",
};
            ...
            <div className="w-full px-4">
              <div className="shadow-three dark:bg-dark mx-auto max-w-[500px] rounded-sm bg-white px-6 py-10 sm:p-[60px]">
                ...
                <p className="text-body-color mb-11 text-center text-base font-medium">
                  Save your favorite properties, get price alerts, and receive the latest Las Vegas real estate market insights.
                </p>
