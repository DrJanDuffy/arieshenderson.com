// Homepage Copy - Conversion-Focused Sections
// This file contains the copy text for each homepage section
// Following structure: Hero, Problem, Value Props, Proof, Process, Pricing/Packages, FAQ, CTA

export const homepageCopy = {
  hero: {
    headline: "GET REAL HOMEBUYER REPRESENTATION",
    subheadline: "Builder's rep works for builder—who's working for YOU?",
    description:
    ...
    primaryCTA: "Get Free Buyer Consultation",
    secondaryCTA: "See How We're Different",
  },

  problem: {
    headline: "The Problem Most Homebuyers Don't See Coming",
    description:
    ...
    points: [
      {
        title: "They're Not On Your Side",
        description:
      ...
      {
        title: "You Pay Full Price (Or More)",
        description:
  ...
  valueProps: {
    headline: "What Happens When You Have Someone Actually Working For You",
    description:
    ...
    points: [
      ...
      {
        title: "We Review Every Contract",
        description:
      ...
      {
        title: "We're There Through Everything",
        description:
  ...
  proof: {
    headline: "Real Results From Real Homebuyers",
    description:
    ...
    testimonials: [
      ...
      },
      {
        ...
        author: "David & Lisa",
        location: "Henderson New Construction",
      },
    ],
    stats: [
      {
      ...
      },
      {
        ...
        description: "Through negotiation and contract protection",
      },
    ],
  },
  ...
  pricing: {
    headline: "How Much Does This Cost?",
    description:
    ...
    packages: [
      {
        ...
        note: "Builder pays our commission. You pay nothing.",
      },
      {
        name: "First-Time Homebuyer Package",
        price: "Free to You",
        description:
  ...
  faq: {
    ...
    description: "Things people ask before working with us:",
    questions: [
      {
  ...
  cta: {
    headline: "Ready to Have Someone Actually Work For You?",
    description:
